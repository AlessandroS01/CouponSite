    ...
    <!-- nel caso non ci sia un utente registrato o loggato si usa la condizione @guest che fa apparire
        le 2 ancore per l'utente che è entrato nel sito come un semplice "ospite". -->
    <ul id="right-links">
